-- Migration 095: Add Wholesale USD Pricing and Fix Bulk Import RPC
-- Add wholesale USD pricing columns to catalog_items and produtos
-- And update the bulk import RPC to handle all necessary fields and sync with catalog_items

-- 1. Update catalog_items
ALTER TABLE public.catalog_items 
ADD COLUMN IF NOT EXISTS sale_price_usd INTEGER DEFAULT 0,
ADD COLUMN IF NOT EXISTS sale_price_usd_rate NUMERIC DEFAULT 0;
...
-- 3. Update Bulk Import RPC to include all fields and sync with catalog_items
...
BEGIN
  ...
  INSERT INTO public.catalog_items (
    ...
    sale_price_usd, sale_price_usd_rate
  )
  SELECT 
    p.id, p.empresa_id, 
    ...
    p.sale_price_usd, p.sale_price_usd_rate
