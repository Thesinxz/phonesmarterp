-- ============================================================
-- Migration 053: Robust Multi-Company Provisioning
-- ============================================================
...
BEGIN
  ...
  -- IMPORTANTE: Verificamos se a tabela existe antes de inserir, para evitar quebra em ambientes antigos
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'usuario_vinculos_empresa') THEN
      INSERT INTO public.usuario_vinculos_empresa (usuario_id, empresa_id, papel)
      VALUES (v_usuario_id, v_empresa_id, 'admin');
  END IF;
