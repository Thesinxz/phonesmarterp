...
export default function NFCeListPage() {
    ...
    return (
        <FeatureGate
            feature="nfce"
            featureName="NFC-e (Nota Fiscal do Consumidor)"
            description="Emita cupons fiscais eletrônicos diretamente no PDV para seus clientes de forma rápida e segura."
        >
