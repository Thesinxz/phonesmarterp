...
export default function CalculadoraInteligente() {
    ...
    const handleCopyWhatsapp = () => {
        ...
        text += `*À Vista (Pix/Dinheiro):* ${formatCurrency(precoBaseVenda)}\n\n`;
        ...
        <div className="space-y-6 page-enter pb-32">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-800 tracking-tight">Calculadora Inteligente</h1>
                        <p className="text-slate-500 text-sm">Precificação estratégica multi-moeda</p>
                    </div>
                </div>
                        ...
                        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                            ...
                            <div className="flex flex-col justify-end h-full gap-4">
                                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 backdrop-blur-sm">
                                    <div className="flex justify-between items-center mb-1">
                                        <p className="text-emerald-400 text-[10px] font-black uppercase">Receber no Pix/Dinheiro</p>
                                    </div>
                                    <p className="text-xl font-bold text-white">
                                        {formatCurrency(Math.round(precoBaseVenda * 100))}
                                    </p>
                                    <p className="text-[9px] text-white/40 mt-1">Valor líquido: {formatCurrency(Math.round(precoBaseVenda * (1 - (selectedGateway?.taxa_pix_pct || 0) / 100) * 100))}</p>
                                </div>
                            </div>
                        </div>
                    </div>
