...
export function ReceberListaClient({ initialTitulos, initialResumo, empresaId }: Props) {
    ...
    async function loadData(background = false) {
        ...
        try {
            const [resumoData, titulosData] = await Promise.all([
                getResumoTitulos(empresaId, 'receber', { startDate: filterStart, endDate: filterEnd }),
                getTitulos(empresaId, 'receber', 1, 50, {
    ...
    return (
        <FeatureGate
            ...
            featureName="Contas a Receber"
            description="Gerencie suas receitas, cobranças e crediário de forma profissional."
        >
            <div className="space-y-6 page-enter pb-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm mt-0.5">Gestão de crediário, parcelas e vendas a prazo ({titulos.length})</p>
                    </div>
